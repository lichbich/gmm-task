  ...
  return (
    <div className="relative">
      ...
      {isRendered && mounted && createPortal(
        <div className="fixed inset-0 z-[100] flex flex-col justify-end sm:justify-start sm:items-end pointer-events-none">
          {/* Backdrop with smooth fade in/out */}
          <div
            className={`fixed inset-0 bg-slate-900/60 backdrop-blur-xs pointer-events-auto modal-backdrop-transition sm:bg-slate-900/20 sm:backdrop-blur-none ${
          ...
          <div
            className={`
              pointer-events-auto relative z-10 w-full flex flex-col bg-white dark:bg-slate-900 rounded-t-3xl border-t border-slate-200 dark:border-slate-800 shadow-2xl overflow-hidden max-h-[85vh] bottomsheet-transition
              sm:mr-6 sm:mt-16 sm:w-[400px] sm:max-h-[540px] sm:rounded-2xl sm:border sm:border-slate-200 sm:dark:border-slate-800 sm:shadow-2xl
